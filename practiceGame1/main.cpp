...
int main() {
    ...
    sf::Vector2f paddleSize(30.0f, window.getSize().y / 7.0f);
    Paddle paddle1(paddleSize, sf::Color(255, 255, 255, 255), sf::Vector2f(80.0f, window.getSize().y / 2.0f - paddleSize.x /*- paddleSize.y*/), 650.0f);
